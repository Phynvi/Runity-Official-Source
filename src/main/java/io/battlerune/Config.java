...
public final class Config {
	...
	public final static Item[] NOT_ALLOWED = {
			new Item(13738, amount), new Item(13739, amount), 
			new Item(13740, amount), new Item(13741, amount), 
			new Item(13742, amount), new Item(13743, amount),
			new Item(13744, amount), new Item(13745, amount), 
			 new Item(13746, amount), new Item(13747, amount),
			 new Item(13748, amount), new Item(13749, amount),
			 new Item(16628, amount), new Item(16629, amount),
			 new Item(16630, amount), new Item(16631, amount),
			 new Item(16647, amount), new Item(16648, amount),
			 new Item(16649, amount), new Item(16650, amount),
			 new Item(16651, amount), new Item(16653, amount),
			 new Item(16654, amount), new Item(16655, amount),
			 new Item(16656, amount), new Item(19923, amount),
			 new Item(16657, amount), new Item(16658, amount),
			 new Item(16659, amount), new Item(16660, amount),
			 new Item(16661, amount), new Item(16662, amount),
			 new Item(16663, amount), new Item(16664, amount),
			 new Item(16665, amount), new Item(16666, amount),
			 new Item(16667, amount), new Item(16668, amount),
			 new Item(16669, amount), new Item(13717, amount),
			 new Item(13718, amount), new Item(13719, amount),
			 new Item(13720, amount), new Item(13721, amount),
			 new Item(13722, amount), new Item(13723, amount),
			 new Item(13724, amount), new Item(13725, amount),
			 new Item(13726, amount), new Item(13727, amount),
			 new Item(13728, amount), new Item(13729, amount),
			 new Item(4062, amount), new Item(17161, amount),
			 new Item(11642, amount), new Item(17153, amount),
			 new Item(17154, amount), new Item(17155, amount),
			 new Item(17156, amount), new Item(17157, amount),
			 new Item(17158, amount), new Item(17159, amount),
			 new Item(17160, amount), new Item(17162, amount),
			 new Item(17163, amount), new Item(17164, amount),
			 new Item(17165, amount), new Item(17166, amount),
			 new Item(17167, amount), new Item(17168, amount),
			 new Item(17172, amount), new Item(17173, amount),
			 new Item(17174, amount), new Item(17175, amount),
			 new Item(17176, amount), new Item(17177, amount),
			 new Item(17178, amount), new Item(17179, amount),
			 new Item(17180, amount), new Item(17181, amount),
			 new Item(19914, amount), new Item(19917, amount),
			 new Item(19920, amount), new Item(13689, amount),
			 new Item(20251, amount), new Item(20252, amount),
			 new Item(13690, amount), new Item(13686, amount),
			 new Item(13687, amount), new Item(11609, amount),
			 new Item(20690, amount), new Item(14581, amount),
			 new Item(14582, amount), new Item(14583, amount),
			 new Item(14584, amount), new Item(14585, amount),
			 new Item(14586, amount), new Item(14589, amount),
			 new Item(13207, amount), new Item(13209, amount),
			 new Item(13210, amount), new Item(13212, amount),
			 new Item(13213, amount), new Item(1321, amount),
			 new Item(13661, amount), new Item(13662, amount),
			 new Item(13189, amount), new Item(10028, amount),
             new Item(21777, amount),
			 new Item(13208, amount), new Item(22123, amount),
			 new Item(21954, amount), new Item(22099, amount),
			 new Item(22078, amount), new Item(22301, amount),
			 new Item(22304, amount), new Item(22307, amount),
			 new Item(15011, amount), new Item(3273, amount),
			 new Item(3274, amount), new Item(3275, amount),
			 new Item(15300, amount), new Item(15307, amount),
			 new Item(10860, amount), new Item(10861, amount),
			 new Item(15301, amount), new Item(15302, amount),
			 new Item(15303, amount), new Item(15304, amount),
			 new Item(3929, amount),  new Item(15308, amount),
			 new Item(15309, amount), new Item(15310, amount),
			 new Item(13703, amount), new Item(13704, amount),
			 new Item(13705, amount), new Item(13695, amount),
			 new Item(13692, amount), new Item(13693, amount), 
			 new Item(13696, amount), new Item(13697, amount),
			 new Item(13698, amount), new Item(13699, amount),
			 new Item(13700, amount), new Item(13701, amount),
			 new Item(13702, amount), new Item(22317, amount),
			 new Item(22280, amount)
			 };
	public final static Item[] BANK_ITEMS = { new Item(995, 10000), new Item(11665, 10000), new Item(11663, 10000),
			...
			new Item(1305, 10000), new Item(7158, 10000), new Item(1434, 10000), new Item(5698, 10000),
			new Item(1215, 10000), new Item(11840, 10000), new Item(6585, 10000), new Item(12954, 10000),
			new Item(11283, 10000), new Item(10551, 10000), new Item(4153, 10000), new Item(10828, 10000),
			new Item(3751, 10000), new Item(2550, 10000), new Item(3105, 10000), new Item(1725, 10000),
			new Item(1704, 10000), new Item(1731, 10000), new Item(1163, 10000), new Item(1127, 10000),
			new Item(1079, 10000), new Item(1201, 10000), new Item(7460, 10000), new Item(4131, 10000),
			new Item(11832, 10000), new Item(11834, 10000), new Item(11836, 10000), new Item(21015, 10000),
			new Item(6570, 10000), new Item(13239, 10000), new Item(11773, 10000), new Item(12931, 10000),
			new Item(13197, 10000), new Item(13199, 10000), new Item(19639, 10000), new Item(19643, 10000),
			new Item(19647, 10000), new Item(11772, 10000), new Item(861, 10000), new Item(892, 10000),
			new Item(9185, 10000), new Item(9244, 10000), new Item(868, 10000), new Item(811, 10000),
			new Item(10498, 10000), new Item(10499, 10000), new Item(3749, 10000), new Item(2503, 10000),
			new Item(2497, 10000), new Item(2491, 10000), new Item(19481, 10000), new Item(11785, 10000),
			new Item(11826, 10000), new Item(11828, 10000), new Item(11830, 10000), new Item(13237, 10000),
			new Item(11771, 10000), new Item(4675, 10000), new Item(12904, 10000), new Item(11791, 10000),
			new Item(11770, 10000), new Item(13235, 10000), new Item(3755, 10000), new Item(1540, 10000),
			new Item(6889, 10000), new Item(2412, 10000), new Item(3840, 10000), new Item(2413, 10000),
			new Item(3844, 10000), new Item(2414, 10000), new Item(3842, 10000), new Item(4089, 10000),
			new Item(4091, 10000), new Item(4093, 10000), new Item(4095, 10000), new Item(4097, 10000),
			new Item(4099, 10000), new Item(4101, 10000), new Item(4103, 10000), new Item(4105, 10000),
			new Item(4107, 10000), new Item(4109, 10000), new Item(4111, 10000), new Item(4113, 10000),
			new Item(4115, 10000), new Item(4117, 10000), new Item(554, 10000), new Item(555, 10000),
			new Item(556, 10000), new Item(557, 10000), new Item(558, 10000), new Item(559, 10000),
			new Item(560, 10000), new Item(561, 10000), new Item(562, 10000), new Item(563, 10000),
			new Item(564, 10000), new Item(565, 10000), new Item(9075, 10000), new Item(6685, 10000),
			new Item(3024, 10000), new Item(2436, 10000), new Item(2440, 10000), new Item(2442, 10000),
			new Item(2444, 10000), new Item(3040, 10000), new Item(2434, 10000), new Item(2448, 10000),
			new Item(6687, 10000), new Item(3026, 10000), new Item(145, 10000), new Item(157, 10000),
			new Item(163, 10000), new Item(169, 10000), new Item(3042, 10000), new Item(139, 10000),
			new Item(181, 10000), new Item(6689, 10000), new Item(3028, 10000), new Item(147, 10000),
			new Item(159, 10000), new Item(165, 10000), new Item(171, 10000), new Item(3044, 10000),
			new Item(141, 10000), new Item(183, 10000), new Item(6691, 10000), new Item(3030, 10000),
			new Item(149, 10000), new Item(161, 10000), new Item(167, 10000), new Item(173, 10000),
			new Item(3046, 10000), new Item(143, 10000), new Item(185, 10000), new Item(12695, 10000),
			new Item(3144, 10000), new Item(391, 10000), new Item(7060, 10000), new Item(385, 10000),
			new Item(4315, 10000), new Item(4317, 10000), new Item(4319, 10000), new Item(4335, 10000),
			new Item(4337, 10000), new Item(4339, 10000), new Item(4355, 10000), new Item(4357, 10000),
			new Item(4359, 10000), new Item(4375, 10000), new Item(4377, 10000), new Item(4379, 10000),
			new Item(4395, 10000), new Item(4397, 10000), new Item(4399, 10000), new Item(4716, 10000),
			new Item(4718, 10000), new Item(4720, 10000), new Item(4722, 10000), new Item(4745, 10000),
			new Item(4747, 10000), new Item(4749, 10000), new Item(4751, 10000), new Item(4732, 10000),
			new Item(4734, 10000), new Item(4736, 10000), new Item(4738, 10000), new Item(4740, 10000),
			new Item(4708, 10000), new Item(4710, 10000), new Item(4712, 10000), new Item(4714, 10000),
			new Item(4753, 10000), new Item(4755, 10000), new Item(4757, 10000), new Item(4759, 10000),
			new Item(12829, 10000), new Item(12821, 10000), new Item(12817, 10000), new Item(12825, 10000),
			new Item(21225, 10000), };

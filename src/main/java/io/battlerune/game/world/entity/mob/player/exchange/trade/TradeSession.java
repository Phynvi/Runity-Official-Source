...
public final class TradeSession extends ExchangeSession {
    ...
    /**
     * The stopwatch which blocks the player from further continueing the session if a second
     * hasn't passed after the last item has been added.
     */
...
//            p.send(new SendString(difference == 0 ? "<col=ffffff> Absolutely nothing!" : "<col=ffffff> " + difference, 33018));
    ...
    /** Determines and returns the text for {@code items} that will be displayed on the confirm trade screen. */

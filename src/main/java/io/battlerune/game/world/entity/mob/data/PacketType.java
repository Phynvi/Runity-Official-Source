...
public enum PacketType {
    ...
    public static final PacketType[] MASTER_WITH_MOVEMENT = {
            CLICK_ITEM, CLICK_OBJECT, COMMANDS, CLICK_NPC, CLICK_BUTTON, USE_ITEM, WIELD_ITEM, MOVE_ITEMS, PICKUP_ITEM,
            USE_MAGIC, DROP_ITEM, INTERACT, WALKING, CHAT, KEY, COMBAT
    };

    public static final PacketType[] MASTER_WITH_COMMANDS = {
            CLICK_ITEM, CLICK_OBJECT, CLICK_NPC, CLICK_BUTTON, USE_ITEM, WIELD_ITEM, MOVE_ITEMS, PICKUP_ITEM,
            USE_MAGIC, DROP_ITEM, INTERACT, WALKING, CHAT, KEY, COMBAT, WALKING, MOVEMENT
    };
}

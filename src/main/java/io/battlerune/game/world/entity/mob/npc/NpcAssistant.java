...
import io.battlerune.game.world.entity.combat.strategy.npc.boss.BluriteDragonStrategy;
...
import io.battlerune.game.world.entity.combat.strategy.npc.boss.Derwen;
...
import io.battlerune.game.world.entity.combat.strategy.npc.boss.Vetion;
import io.battlerune.game.world.entity.combat.strategy.npc.boss.Vorkath;
...
public class NpcAssistant {
    ...
    private static final int[] DRAGONS = {
        ...
        /* Black */ 239, 252, 253, 254, 255, 256, 257, 258,
    ...
    public static boolean isDragon(int id) {
        for (int dragon : DRAGONS) if (id == dragon) return true;
        return false;
    }

...
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.AbyssalBludgen;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.AbyssalDagger;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.AbyssalTentacleWhip;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.AbyssalWhip;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.AnicentMace;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.ArmadylGodsword;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.BandosGodsword;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DefaultMelee;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DinhsBulwark;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.Dragon2h;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DragonClaws;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DragonDagger;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DragonHaldberd;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DragonLongsword;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DragonMace;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DragonScimitar;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DragonSpear;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DragonSword;
import io.battlerune.game.world.entity.combat.strategy.player.special.melee.DragonWarhammer;
...
import io.battlerune.game.world.entity.combat.strategy.player.special.range.Blowpipe;
import io.battlerune.game.world.entity.combat.strategy.player.special.range.DarkBow;
import io.battlerune.game.world.entity.combat.strategy.player.special.range.DragonThrownaxe;
import io.battlerune.game.world.entity.combat.strategy.player.special.range.MagicShortbow;
...
import io.battlerune.net.packet.out.SendInterfaceLayer;

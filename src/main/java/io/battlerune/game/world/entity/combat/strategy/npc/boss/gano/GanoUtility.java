...
public class GanoUtility {
	...
	public static Npc generateSpawn() {
		...
		World.sendMessage("<col=8714E6> gano has just spawned! He is located at " + spawn.location + "!",
	...
	public static void defeated(Npc gano, Player player) {
		...
		if (hasClan) {
			...
			World.sendMessage("<col=8714E6> gano has been defeated by " + player.getName() + ", a clan member of "

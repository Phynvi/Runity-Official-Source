...
public abstract class Area {
   ...
   // public static final Area Dropcatcher_MINIGAME = new SquareArea("RFD Minigame", 1889, 5345, 1910, 5366, 2);
   ...
   // private static final ImmutableList<Area> BOSS_ARENA = ImmutableList.of(new SquareArea("Boss Arena", 3052, 5357, 3027, 5331));
   ...
   /* public static boolean inBossArena(Interactable entity) {
   ...
   /* public static boolean inDropcatcher(Interactable entity) {
        return Dropcatcher_MINIGAME.inArea(entity.getPosition());
    }*/

...
public class ItemContainer implements Iterable<Item> {
    ...
    /** FOR ADAM - Incase the items capactity exceeds the length
     *  this is the original code, if anything occurs, or errors.
     *  changed it from capacity to items.length (in the for loop)
     *  
     *  **/

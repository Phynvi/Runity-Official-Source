...
/*                if(staticObject.getDefinition().getName().equals("Large door"))
                {
                    System.out.println("Large door added at " + staticObject.getPosition() + "(type=" + staticObject.getObjectType());
                }*/
                ...
                else if (Area.inBattleRealmMap(pos) && (type.get().getGroup() == ObjectGroup.INTERACTABLE_OBJECT || type.get() == ObjectType.STRAIGHT_WALL) && !staticObject.getDefinition().getName().equals("null"))
                {
                    ...
                    //System.out.println("Added new objectArg with name " + staticObject.getDefinition().getName());
                    region.skip(staticObject);

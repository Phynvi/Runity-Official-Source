package io.battlerune.util.database.query.command.impl;


import io.battlerune.util.database.query.command.SQLCommand;
import io.battlerune.util.database.query.options.impl.LimitClauseOption;
import io.battlerune.util.database.query.options.impl.OrderByKeywordOption;

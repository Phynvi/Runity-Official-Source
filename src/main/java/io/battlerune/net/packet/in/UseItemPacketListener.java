...
public class UseItemPacketListener implements PacketListener {
    ...
    /** Handles an randomevent when a player uses the "Use" option of an item with an item on the ground. */
    ...
    /** Handles an randomevent when a player uses the "Use" option of an item with another item in a players inventory. */
    ...
    /** Handles an randomevent when a player uses the "Use" option of an item with an in-game npc. */
    ...
    /** Handles an randomevent when a player uses the "Use" option of an item with an in-game object. */
    ...
    /** Handles an randomevent when a player uses the "Use" option of an item with an in-game player. */

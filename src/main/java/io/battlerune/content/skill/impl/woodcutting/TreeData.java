...
public enum TreeData {
    //int level, int item, int replacement, int respawn, double experience, int petRate, int logs, double success, int[] tree
    ...
    AFK_TREE(1, 2862, 5, 5, 5.0, 317_647, 20_000, 1.0, new int[]{2092});

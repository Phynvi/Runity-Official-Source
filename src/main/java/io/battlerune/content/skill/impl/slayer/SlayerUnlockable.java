...
public enum SlayerUnlockable {
	...
	BROAD_BOLT("Broader fletching", 11874, 250, "Learn to fletch broad arrows (with level 52\\nfletching) and broad bolts (with level 55 \\nfletching)."),
	...
	ZULRAH("Give me venom", 12924, 300, "Unlock the ability to be assigned Zulrah as\\na Slayer task, 95 Slayer needed."),
	CERBERUS("Beast Slayer", 13239, 250, "Unlock the ability to be assigned Cerberus\\nas a Slayer task, 85 Slayer needed."),
	KING_BLACK_DRAGON("King killer", 11283, 300, "Unlock the ability to be assigned King black\\ndragon as a Slayer task, 75 Slayer needed."),
	CHAOS_ELEMENT("I strive on chaos", 12694, 150, "Unlock the ability to be assigned Chaos\\nelemental as a Slayer task, 65 Slayer\\nneeded."),

...
public enum SlayerTask implements TaskInterface<Player> {
    //    GOBLIN("Goblin", 2, 300, TaskDifficulty.EASY, new Position(1, 1), "Lumbridge", 655, 656, 657, 658, 659, 660, 661, 662, 663, 664, 665, 666, 667, 668) {
//        @Override
...
//    },
    ...
    //    AVIANSIES("Aviansies", 1, 300, TaskDifficulty.MEDIUM, new Position(1, 1), "Stronghold of Security", 3169, 3170, 3171, 3172, 3163, 3174, 3175, 3176, 3177, 3178, 3179, 3180, 3181, 3182, 3183) {
//        @Override
//        public boolean canAssign(Player player) {
//            return true;
//        }
...
//    },
    ...
    //    WATERFIENDS("Waterfiend", 1, 375, TaskDifficulty.HARD, new Position(1, 1), "Ancient Caverns", 2916, 2917) {
//        @Override
//        public boolean canAssign(Player player) {
//            return true;
//        }
...
//        }
//    },
    //    SPIRTUAL_RANGERS("Spiritual Ranger", 63, 50, TaskDifficulty.HARD, new Position(1, 1), "Godwars Dungeon", 2211) {
//        @Override
//        public boolean canAssign(Player player) {
//            return true;
//        }
...
//    },
    ...
    //    SPIRTUAL_MAGES("Spiritual Mage", 83, 50, TaskDifficulty.HARD, new Position(1, 1), "Godwars Dungeon", 2212) {
//        @Override
//        public boolean canAssign(Player player) {
//            return true;
//        }

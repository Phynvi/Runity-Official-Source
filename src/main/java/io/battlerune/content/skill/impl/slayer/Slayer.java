...
public class Slayer {
    ...
    private final static StoreItem[] STORE_ITEMS = {
            ...
            new StoreItem(11739, 1, 500),
            new StoreItem(8901, 1, 500),
            new StoreItem(13239, 1, 650),

            new StoreItem(19647, 1, 750),
            new StoreItem(19643, 1, 750),
            
            new StoreItem(19639, 1, 800),

            new StoreItem(10551, 1, 800),
            new StoreItem(13576, 1, 850),

            new StoreItem(11941, 1, 950),
            new StoreItem(12821, 1, 1050),
    ...
    /** Handles invitation
     * Note: This function has nothing to do with the player who calls it via player.slayer.startDuoDialogue **/
    public void startDuoDialogue(Player inviter, Player receiver)
    {
        ...
        inviter.dialogueFactory.sendStatement("How do you want to share your slayer task with " + receiver.getName() + "?").sendOption(
                "Share Task", () -> {
    ...
    private void detailsOnDuo(Player inviter, Player receiver, boolean shared) {
        ...
        player.dialogueFactory.sendStatement("If accepted, together with " + inviter.getName() + " you would have",
                "to slay " + (shared ? inviter.slayer.getAmount() : 2*inviter.slayer.getAmount()) + " " + inviter.slayer.getTask().getName() + ".")
                .sendOption("Accept", () -> {

...
public class Slayer {
	...
	public void cancel() {
		...
		int cost = PlayerRight.isDonator(player) ? 5 : 10;
	...
	private final static StoreItem[] STORE_ITEMS = { new StoreItem(4155, 1, 0), new StoreItem(4166, 1, 5),
			...
			new StoreItem(13703, 1, 25750),
			new StoreItem(13704, 1, 25750),
			new StoreItem(13705, 1, 25750),
			new StoreItem(21225, 1, 35000),
			new StoreItem(11642, 1, 40000),

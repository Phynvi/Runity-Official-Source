        ...
        return new Action<Player>(player, 3) {
            ...
            protected void execute() {
                ...
                if (firemaking == FiremakingData.OAK_LOG) {
                    ...
                    /*
                    if(PlayerRight.isDonator(player) || PlayerRight.isSuper(player) || PlayerRight.isDeveloper(player)) {
                    ...
                    if(PlayerRight.isExtreme(player) || PlayerRight.isElite(player)) {
                  	  player.setskillingPoints(player.getskillingPoints() + 3);
						  player.message("<img=14>You now have @red@" + player.getskillingPoints() + " Boss Points!");
                    }
                ...
                if(firemaking == FiremakingData.NORMAL_LOG || firemaking == FiremakingData.OAK_LOG || firemaking == FiremakingData.WILLOW_LOG || firemaking == FiremakingData.MAPLE_LOG || firemaking == FiremakingData.MAGIC_LOG ||
                		firemaking == FiremakingData.ARCTIC_PINE_LOG) {

...
public enum RunecraftData {
	...
	WATER(14899, 555, 7.0D, new int[] { 5, 19, 38, 57, 76, 95 }), EARTH(14900, 557, 7.5D, new int[] { 9, 26, 52, 78 }),
	FIRE(14901, 554, 8.0D, new int[] { 14, 35, 70 }), BODY(14902, 559, 8.5D, new int[] { 20, 46, 92 }),
	COSMIC(14903, 564, 10.0D, new int[] { 27, 59 }), CHAOS(14906, 562, 10.5D, new int[] { 35, 74 }),
	NATURE(14905, 561, 11.0D, new int[] { 44, 91 }), LAW(14904, 563, 10.5D, new int[] { 54 }),
	DEATH(14907, 560, 12.0D, new int[] { 65 }), BLOOD(27978, 565, 12.5D, new int[] { 77 });

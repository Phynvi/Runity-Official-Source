...
public enum OreData {
	...
	CLAY(434, 1, 5, 0, 7468, 15, 741_600, 5, 0.3, new int[] { 7454, 7487 }, 1),
	COPPER(436, 1, 17.5, 0, 7468, 15, 741_600, 5, 0.5, new int[] { 7484, 7453 }, 3),
	TIN(438, 1, 17.5, 0, 7468, 15, 741_600, 5, 0.5, new int[] { 7485, 7486 }, 5),
	IRON(440, 15, 35, 0, 7468, 20, 741_600, 8, 0.2, new int[] { 7488, 7455 }, 7),
	SILVER(442, 20, 40, 0, 7468, 25, 741_600, 8, 0.2, new int[] { 7457, 7490 }, 9),
	COAL(453, 30, 50, 0, 7468, 25, 290_640, 9, 0.2, new int[] { 7456, 7489 }, 11),
	GOLD(444, 40, 65, 0, 7468, 30, 296_640, 7, 0.15, new int[] { 7491, 7458 }, 13),
	MITHRIL(447, 55, 80, 0, 7468, 50, 148_320, 9, 0.05, new int[] { 7492, 7459 }, 15),
	ADAMANTITE(449, 70, 95, 0, 7468, 75, 59_328, 11, 0.03, new int[] { 7493, 7460 }, 17),
	RUNITE(451, 85, 125, 0, 7468, 100, 42_337, 13, 0.02, new int[] { 7494 }, 19),
	RUNE_ESSENCE(1436, 1, 25, 0, -1, 20, 326_780, Integer.MAX_VALUE, 0.1, new int[] { 7494, 7471 }, 21),
	GEM_ROCK(1623, 40, 85, 0, -1, 75, 326_780, 2, 0.2, new int[] { 9030 }, 23),
	HERB3(203, 19, 19, 0, 8139, 15, 741_600, 5, 0.5, new int[] { 8001 }, 25),

...
public enum FinishedPotion implements Potion {
	ATTACK_POTION(121, 91, 221, 1, 25, 500), ANTIPOISON(175, 93, 235, 5, 37.5, 1000),
	STRENGTH_POTION(115, 95, 225, 12, 50, 1250), RESTORE_POTION(127, 97, 223, 22, 62.5, 1500),
	ENERGY_POTION(3010, 97, 1975, 26, 67.5, 1750), DEFENCE_POTION(133, 99, 239, 30, 75, 2000),
	AGILITY_POTION(3034, 3002, 2152, 34, 80, 2250), COMBAT_POTION(9741, 97, 9736, 36, 84, 2500),
	PRAYER_POTION(139, 99, 231, 38, 87.5, 3000), SUPER_ATTACK(145, 101, 221, 45, 100, 3250),

...
import io.battlerune.content.skill.impl.fletching.impl.Arrow;
import io.battlerune.content.skill.impl.fletching.impl.Bolt;
import io.battlerune.content.skill.impl.fletching.impl.Carvable;
import io.battlerune.content.skill.impl.fletching.impl.Crossbow;
import io.battlerune.content.skill.impl.fletching.impl.Featherable;
...
public class SkillRepository {
	...
	private static final Position[] HUNTER_SPAWN_POSITION = { new Position(3081, 3484), new Position(3101, 3484),
			new Position(3115, 3506), new Position(3094, 3453), new Position(3134, 3511), new Position(3180, 3422),
			new Position(3240, 3440), new Position(3287, 3351), new Position(3257, 3247), new Position(3221, 3213),
			new Position(2803, 3445), new Position(2721, 3472), new Position(3349, 3271), new Position(3283, 3196),

...
public class SkillRepository {
    ...
    private static final Position[] HUNTER_SPAWN_POSITION = {
            ...
            new Position(2318, 3813), new Position(3054, 3514), new Position(2572, 4329),
            new Position(2583, 4339), new Position(2593, 4333), new Position(2610, 4308),
            new Position(2595, 4297), new Position(2598, 4312), new Position(2570, 4344),
            new Position(2585, 4342), new Position(2604, 4336), new Position(2594, 4322)
    };

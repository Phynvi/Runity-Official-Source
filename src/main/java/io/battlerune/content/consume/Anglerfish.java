 ...
 * 
 * @author Adam_#6723
 * Handles the overhealing of anglerfish, don't ask why i created seperate class...didn't wanna touch the aids they call "eat.java".
 *
 */
...
public class Anglerfish {
	   ...
	   /**
	     ...
	     * This method only executes after they've elapsed the food delay tier.
	     */
	    ...
	    /**
	     * The method that executes the basic effect food action that will

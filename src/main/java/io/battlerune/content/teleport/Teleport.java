...
public enum Teleport {
    /* Minigames */
    ARENA("Mage Arena", TeleportType.MINIGAMES, new Position(2540, 4717, 0), false, new int[]{2412, 2413, 2414}, "You will be teleported in a safe area", ""),
    ...
    GAMBLE("Gamble", TeleportType.MINIGAMES, new Position(2459, 3094, 0), false, new int[]{-1, 995}, "The place to be if you want to lose bank", "Here comes the money!"),
    ...
    KOLODIONS_ARENA("Kolodion's Arena", TeleportType.MINIGAMES, new Position(2540, 4717, 0), false, new int[]{6918, 6916, 6924}, "You will be teleported in a safe area", ""),
    ...
    HUNTER("Hunter", TeleportType.SKILLING, new Position(3039, 4836, 0), true, new int[]{9950, 9948, 9949}, "Looking to hunt the biggest game?", "Go pking, cause this shits too easy"),
    MINING("Mining", TeleportType.SKILLING, new Position(3039, 4836, 1), true, new int[]{9794, 9792, 9793}, "Let your natural slave roots take over...", "Mine those damn rocks!"),
    THIEVING("Thieving", TeleportType.SKILLING, new Position(3046, 4969, 1), false, new int[]{9779, 9777, 9778}, "Working hard? What's that?", "Let's just steal our gold!"),
    RUNECRAFTING("Runecrafting", TeleportType.SKILLING, new Position(3039, 4836, 0), false, new int[]{9767, 9765, 9766}, "There's no feeling that can compare with", "crafting runes out of your ass!"),
    WOODCUTTING("Woodcutting", TeleportType.SKILLING, new Position(2727, 3484, 0), true, new int[]{9809, 9807, 9808}, "HOW MUCH WOOD WOULD A WOODCHUCK CHUCK IF A", "WOODCHUCK COULD CHUCK WOOD?"),
    ...
    AL_KHARID_WARRIORS("Al-Kharid Warriors", TeleportType.MONSTER_KILLING, new Position(3293, 3182, 0), false, new int[]{}, "", ""),
    ...
    SLAYER_TOWER("Slayer Tower", TeleportType.MONSTER_KILLING, new Position(3429, 3538, 0), false, new int[]{}, "", ""),
    ...
    DARK_BEAST("Dark Beasts", TeleportType.MONSTER_KILLING, new Position(2018, 4639, 0), false, new int[]{-1, 11235}, "What these fellas lack in their downstairs area", "make it up with they're 'long' horn"),
    ...
    MITHRIL_DRAGONS("Mithril Dragons", TeleportType.MONSTER_KILLING, new Position(1748, 5326, 0), false, new int[]{-1, 11286}, "", ""),
    ...
    EDGEVILLE("Edgeville", TeleportType.PLAYER_KILLING, new Position(3087, 3517, 0), false, new int[]{}, "You will be teleported in a safe area", "Time to destroy some people!"),
    ...
    WILDERNESS_RESOURCE2("Wilderness Resource", TeleportType.PLAYER_KILLING, new Position(3184, 3947, 0), false, new int[]{11934, 451, 1513}, "This teleport is in the lvl 50+ wilderness!", "YOLO tho, am I right??"),
    
    /* CITIES */
    VARROCK("Varrock", TeleportType.CITIES, new Position(3210, 3424, 0), false, new int[]{8007, 8007, 8007}, "Takes you to the Capital of Runity", "Where the markets are filled with goods"),
    LUMBRIDGE("Lumbridge", TeleportType.CITIES, new Position(3222, 3218, 0), false, new int[]{8008, 8008, 8008}, "A once dangerous land"," but now home to the king of lumbridge!"),
    ALKHARID("Al Kharid", TeleportType.CITIES, new Position(3275, 3166, 0), false, new int[]{1833, 1835, 1837}, "Home to the arabs and their spices!", ""),
    CAMELOT("Camelot", TeleportType.CITIES, new Position(2757, 3477, 0), false, new int[]{8010, 8010, 8010}, "Camelot, alot to do, alot to accomplish in this area.", ""),
    CATHERBY("Catherby", TeleportType.CITIES, new Position(2804, 3435, 0), false, new int[]{-1, 11995}, "Catherby is considered the fishing town of runity", ""),
    DRAYNOR("Draynor", TeleportType.CITIES, new Position(3104, 3248, 0), false, new int[]{19615, 19615, 19615}, "Draynor is a town that is extremely useful for you crafters!", ""),
    PORTSARIM("Port Sarim", TeleportType.CITIES, new Position(3019, 3217, 0), false, new int[]{272, 307, 10136}, "The capital of all fishing villages" , " has the largest exports of exotic rare fishes!"),
    TREEGNOMESTRONGHOLD("Gnome Stronghold", TeleportType.CITIES, new Position(2440, 3403, 0), false, new int[]{3257, 9470, 13655}, "The gnome's hold these lands", ""),

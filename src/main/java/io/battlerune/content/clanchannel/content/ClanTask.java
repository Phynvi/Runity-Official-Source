...
import static io.battlerune.content.clanchannel.content.ClanTaskKey.ABYSSAL_DEMON;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.AFK_LOG;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.AGILITY_COURSE;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.BLACK_DEMON;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.BLACK_DRAGON;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.BLOOD_RUNE;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.BLUE_DRAGON;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.BOT_KILLING;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.BURN_WILLOW_LOG;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.CALLISTO;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.CHAOS_ELEMENTAL;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.CHAOS_FANATIC;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.CHOP_ANY_LOG;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.CHOP_WILLOW_LOG;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.COMPLETE_MASTERMINER_TASK_KEY;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.CRAZY_ARCHAEOLOGIST;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.DARK_CRAB;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.DEATH_RUNE;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.GREATER_DEMON;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.GREEN_DRAGON;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.HILL_GIANT;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.KING_BLACK_DRAGON;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.MAGIC_LOG;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.MAGIC_SHORTBOW;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.PLAYER_KILLING;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.RED_DRAGON;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.ROCK_CRAB;
...
import static io.battlerune.content.clanchannel.content.ClanTaskKey.THIEVING_STALL;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.TRIVIA_ANSWER_KEY;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.VENNANTIS;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.YEW_LOG;
import static io.battlerune.content.clanchannel.content.ClanTaskKey.YEW_SHORTBOW;
...
//    CREATE_SUPER_COMBAT_POTION(ClanType.SKILLING, Difficulty.HARD, "Create % super combat potions", SUPER_COMBAT_POTION, new InclusiveRandom(, 2000)),
	...
	COMPLETE_MASTERMINER_TASK(ClanType.SOCIAL, Difficulty.EASY, "Complete %s MasterMiner Tasks!",
			COMPLETE_MASTERMINER_TASK_KEY, new InclusiveRandom(2, 6)),
	...
	/* -> Medium <- */
	COMPLETE_MASTERMINER_TASK_IRONMAN(ClanType.SOCIAL, Difficulty.MEDIUM, "Complete %s MasterMiner Tasks!",
			COMPLETE_MASTERMINER_TASK_KEY, new InclusiveRandom(4, 10)),

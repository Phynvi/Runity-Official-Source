...
//    CREATE_SUPER_COMBAT_POTION(ClanType.SKILLING, Difficulty.HARD, "Create % super combat potions", SUPER_COMBAT_POTION, new InclusiveRandom(, 2000)),
    ...
    /** Social **/
    /*          ->     Easy     <-          */
    SEND_CLAN_MESSAGES(ClanType.SOCIAL, Difficulty.EASY, "Send %s Clan Messages!", SEND_CLAN_MESSAGE, new InclusiveRandom(50, 75)),
    COMPLETE_MASTERMINER_TASK(ClanType.SOCIAL, Difficulty.EASY, "Complete %s MasterMiner Tasks!", COMPLETE_MASTERMINER_TASK_KEY, new InclusiveRandom(2, 6)),

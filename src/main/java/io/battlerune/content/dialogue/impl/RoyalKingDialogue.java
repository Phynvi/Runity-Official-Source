...
public class RoyalKingDialogue extends Dialogue {
    ...
    public void sendDialogues(DialogueFactory factory) {
        ...
        factory.sendOption("Claim Purchase", () -> claim(factory), "Donator Information", () -> player.send(new SendURL("www.nearreality.io/store")), "Open Store", () -> store(factory), "Nevermind", factory::clear);
        factory.execute();
    }
    ...
    private void store(DialogueFactory factory) {
        factory.sendOption("Open Donator Store", () -> Store.STORES.get("Donator Store").open(factory.getPlayer()), 
        		"Second Donator Store", () -> Store.STORES.get("Second Donator Store").open(factory.getPlayer()),
        		"Ironman Donator Store",() -> Store.STORES.get("Ironman Donator Store").open(factory.getPlayer()),

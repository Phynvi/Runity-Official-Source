...
public class SailorKingDialouge extends Dialogue {
  ...
  /*  private void claim(DialogueFactory factory) {
    ...
    private void store(DialogueFactory factory) {
        factory.sendOption("Open Boss Point Store", () -> Store.STORES.get("Boss Point Store").open(factory.getPlayer()), 
        		"Open Skilling Point Store", () -> Store.STORES.get("Skilling Point Store").open(factory.getPlayer()),
        		"Open Trivia Point Store",() -> Store.STORES.get("Trivia Point Store").open(factory.getPlayer()),

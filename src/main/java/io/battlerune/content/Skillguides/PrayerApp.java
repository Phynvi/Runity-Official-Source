...
public class PrayerApp {
    ...
    public enum PrayerApplication {
    	//RANGE0(HEREGOESTHELEVEL REQUIRED, ITEMID)
    	 ...
    	 Prayer6(65, new Item(11832)), 
    	 Prayer7(70, new Item(4720)), 
    	 Prayer8(70, new Item(12831)), 
    	 Prayer9(75, new Item(11283)), 
    	 Prayer10(75, new Item(21015)), 
    	 Prayer11(99, new Item(9754)); //99CAPE
    ...
    public static void open(Player player) {
        ...
        player.send(new SendString("Near-Reality Prayer Guide", 37103));

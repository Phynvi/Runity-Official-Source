...
public class HerbloreApp {
    ...
    public enum HerbloreApplication {
    	 ...
    	 Herblore7(30, new Item(2998)), 
    	 Herblore8(40, new Item(259)), 
    	 Herblore9(48, new Item(261)), 
    	 Herblore10(54, new Item(263)), 
    	 Herblore11(59, new Item(3000)), 
    	 Herblore12(65, new Item(265)), 
    	 Herblore13(67, new Item(2481)), 
    	 Herblore14(70, new Item(267)), 
    	 Herblore15(75, new Item(269)), 
    ...
    public static void open(Player player) {
        ...
        player.send(new SendString("Near-Reality Herblore Guide", 37103));

...
public class RunecraftingApp {
    ...
    public enum RunecraftApp {
    	 ...
    	 Runecrafting6(27, new Item(562)), 
    	 Runecrafting7(35, new Item(11699)), 
    	 Runecrafting8(40, new Item(11693)), 
    	 Runecrafting9(44, new Item(11695)), 
    	 Runecrafting10(54, new Item(11692)), 
    	 Runecrafting11(65, new Item(11697)), 
    	 Runecrafting12(77, new Item(11698)), 
    	 Runecrafting13(90, new Item(11698)), //This needs to be changed to wrath runes
    ...
    public static void open(Player player) {
        ...
        player.send(new SendString("Near-Reality Runecrafting Guide", 37103));

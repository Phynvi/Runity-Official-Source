...
public class DefenceApp {
    ...
    public enum DefenceApplication {
    	 Defence0(1, new Item(1175)), //
          ...
          Defence30(65, new Item(11832)), 
        Defence40(70, new Item(4720)), 
        Defence70(70, new Item(12831)), 
        Defence71(75, new Item(11283)), 
        Defence75(75, new Item(21015)), 
      	Defence99(99, new Item(9754)); //99CAPE
    ...
    public static void open(Player player) {
        ...
        player.send(new SendString("Near-Reality Defence Guide", 37103));

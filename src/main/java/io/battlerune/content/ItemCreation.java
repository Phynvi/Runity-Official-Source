...
public class ItemCreation {
    ...
    public enum CreationData {
        ...
        BLACK_SLAYER_HELM(new Item[]{new Item(19639)}, null, new Skill[]{new Skill(Skill.CRAFTING, 99, 0)}, new Item(11864), new Item(7980)),
        BLACK_SLAYER_HELM_I(new Item[]{new Item(19641)}, null,new Skill[]{new Skill(Skill.CRAFTING, 99, 0)}, new Item(11865), new Item(7980)),



        GREEN_SLAYER_HELM(new Item[]{new Item(19643)}, null,new Skill[]{new Skill(Skill.CRAFTING, 99, 0)}, new Item(11864), new Item(7981)),
        GREEN_SLAYER_HELMI(new Item[]{new Item(19645)}, null,new Skill[]{new Skill(Skill.CRAFTING, 99, 0)}, new Item(11865), new Item(7981)),
        RED_SLAYER_HELM(new Item[]{new Item(19647)}, null, new Skill[]{new Skill(Skill.CRAFTING, 99, 0)}, new Item(11864), new Item(7979)),
        RED_SLAYER_HELMI(new Item[]{new Item(19649)}, null, new Skill[]{new Skill(Skill.CRAFTING, 99, 0)}, new Item(11865), new Item(7979)),
        PURPLE_SLAYER_HELM(new Item[]{new Item(21264)}, null, new Skill[]{new Skill(Skill.CRAFTING, 99, 0)}, new Item(11864), new Item(21275)),
        PURPLE_SLAYER_HELMI(new Item[]{new Item(21266)}, null, new Skill[]{new Skill(Skill.CRAFTING, 99, 0)}, new Item(11865), new Item(21275)),
        ...
        SERPENTINE_VISAGE(new Item(12929), new Item(12927, 1), new Skill[]{new Skill(Skill.CRAFTING, 52, 0)}, new Item(12927, 1), new Item(1755, 1)),

...
public enum ItemPack {
	 STARTERKIT(6828, false, new Item(662), new Item(1031), new Item(1731), new Item(1323), new Item(6388), new Item(6386), new Item(1837),
			    new Item(995, 50000), new Item(13065, 5), new Item(380, 150),
			    new Item(1333), new Item(841), new Item(853), new Item(884, 250), new Item(554, 250),
			    new Item(555, 250), new Item(556, 250), new Item(557, 250), new Item(558, 250),
			    new Item(563, 50), new Item(561, 30), new Item(562, 100)),
    // barrows

...
public class StarterKit {
    ...
    public enum KitData {
        NORMAL(PlayerRight.PLAYER, new String[]{
                ...
                new Item(557, 4000), new Item(3025, 75), new Item(6686, 20), new Item(12696, 10),
                new Item(841), new Item(861), new Item(995, 850000), new Item(1321), new Item(1325), new Item(4587), new Item(1215), new Item(884, 1000), new Item(1704)
        ),

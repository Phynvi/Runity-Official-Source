...
public class StarterKit {
	...
	public enum KitData {
		...
		NORMAL(PlayerRight.PLAYER, new String[] {
				"", "Play Runity as a normal player.", "As a normal player you will have no restrictions at all." },
				new Item[] { new Item(3842) },
		...
		CLASSIC(PlayerRight.CLASSIC, new String[] {
				"", "Play Runity as a Classic player.", "As a normal player you will have no restrictions at all." },
				new Item[] { new Item(3842) },
				new Item[] { new Item(10828, 1), new Item(1127, 1), new Item(1079, 1), new Item(3105),
						new Item(386, 300), new Item(565, 1000), new Item(555, 5000), new Item(560, 4000),
						new Item(557, 4000), new Item(3025, 75), new Item(6686, 20), new Item(12696, 10), new Item(841),
		...
		IRONMAN(PlayerRight.IRONMAN,
				...
				new Item[] { new Item(12810), new Item(12812), new Item(12811), new Item(1277), new Item(1173),
						new Item(4119) },
				new Item[] { new Item(995, 10000), new Item(1351, 1), new Item(590, 1), new Item(303, 1),
						new Item(315, 1), new Item(1925, 1), new Item(1931, 1), new Item(2309, 1), new Item(1265, 1),
						new Item(1205, 1), new Item(1277, 1), new Item(1171, 1), new Item(841, 1), new Item(882, 25),
						new Item(556, 25), new Item(558, 15), new Item(555, 6), new Item(557, 4), new Item(559, 2), new Item(16662, 1) }),

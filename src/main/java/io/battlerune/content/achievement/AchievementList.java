...
public enum AchievementList {
   ...
   // FLETCH250ADAMANET(500, AchievementKey.FLETCH250ADAMANET, AchievementDifficulty.MEDIUM, "Fletch 500 Adamanet Cbows"),   
    ...
    /* Hard achievements */
    SKILL_MASTERY_II(Skill.SKILL_COUNT, AchievementKey.SKILL_MASTERY, AchievementDifficulty.HARD, "Achieve level 99 in all skills"),
    ...
    EXPERIENCE_MASTERY_II(Skill.SKILL_COUNT, AchievementKey.EXPERIENCE_MASTERY, AchievementDifficulty.ELITE, "Earn 200M EXP in all skills"),
    ...
    HIGH_ALCHEMY_II(5000, AchievementKey.HIGH_ALCHEMY, AchievementDifficulty.ELITE, "Cast high alchemy spell 5000 times"),

...
public class ProfileViewer {
    ...
    public static String[] string(Player player) {
        return new String[]{
                ...
                "Session time:", Utility.getTime(player.sessionPlayTime),
                "Networth:", "" + Utility.formatPrice(player.playerAssistant.networth()) + " RT",
                "Clan:", player.clan == null ? "None" : player.clan,
                ...
                "Current KC/Highest KC", "0/0",
                "Achievements Completed:", "" + AchievementHandler.getTotalCompleted(player) + "",
                "Quests Completed:", "" + player.quest.getCompleted()
        };
    }

...
public enum ActivityType {
	...
	SCHOOL_GAME(false), BATTLE_REALM(false), FIGHT_CAVES(true),ALLVSONE2(true),  ALLVSONE3(true), ALLVSONE(true), INFERNO(true), KOLODION_ARENA(true), RECIPE_FOR_DISASTER(true),

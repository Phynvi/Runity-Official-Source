    ...
    DIVE() {
        ...
        public void execute(ZulrahActivity activity) {
            ...
            if (count == 0) {
                ...
                if (next == 2042) ((Zulrah) zulrah.getStrategy()).setRanged();
                else if (next == 2043) ((Zulrah) zulrah.getStrategy()).setMelee();
                else if (next == 2044) ((Zulrah) zulrah.getStrategy()).setMagic();

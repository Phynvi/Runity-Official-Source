...
//        System.out.println(stage);
		...
		case 3:
			...
			factory.sendNpcChat(306, "Welcome to <col=D63E3E>Runity</col>, " + player.getName(),
		...
		case 4:
			...
			factory.sendNpcChat(306, "Wise choice my friend! Lets get started.",
		...
		case 6:
			...
			factory.sendNpcChat(306, "The purple button will provide you with various options.",
		...
		case 7:
			...
			factory.sendNpcChat(306, "This is your wrench tab. Here you can change all options",
		...
		case 15:
			...
			break;
		case 16:
			factory.sendNpcChat(306, "Here are shops that will sell you all the",
					"general items you will need in your adventure.", "The bounty hunter npc has a wide variety of",
		...
		case 20:
			factory.sendNpcChat(306, "This is the Well of goodwill,",
					"you will be able to contribute gold for a server wide", "experience bonus that will last 1 hour.")
					.onAction(this::next).execute();
			pause();
			break;
		case 21:
		...
		case 23:
			...
			break;
		case 24:
			factory.sendNpcChat(306, "This is the home skilling area. Only members with",
					"1,250 + total level can skill here.");
			factory.onAction(() -> {
				player.face(Direction.SOUTH);
				next();
				player.locking.lock();

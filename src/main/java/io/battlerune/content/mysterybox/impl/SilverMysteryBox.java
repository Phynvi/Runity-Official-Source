...
public class SilverMysteryBox implements MysteryBoxListener {
	...
	public Item[] getCommon() {
		return new Item[] {
				new Item(995, randomAmount), 
				new Item(396, 100), //raw sea turtle
	...
	public Item[] getUncommon() {
		return new Item[] { new Item(995, randomAmount1), 
				new Item(7142, 1), // rapier
	...
	//@Override
	public Item[] getRare() {
		return new Item[] { new Item(995, randomAmount2), 
				new Item(7673, 1), //blue boxing gloves
		...
		TaskManager.schedule(new Task(1) {
			...
			protected void execute() {
				...
				case 1:
					 ...
					 * Utility.random(1, 250) <= 10 <---- This generates a RANDOM NUMBER between 1 and 150 and if the RANDOM NUMBER is equal to 10

...
public class MysteryBox implements MysteryBoxListener {
	...
	public Item[] getCommon() {
		return new Item[] { new Item(995, Utility.random(1000000, 2500000)), new Item(4151, 1) };
	}

	@Override
	public Item[] getUncommon() {
		return new Item[] { new Item(995, Utility.random(2500000, 3500000)), new Item(4151, 1) };
	}

	@Override
	public Item[] getRare() {
		return new Item[] { new Item(995, Utility.random(3500000, 5000000)), new Item(4151, 1) };
	}

	@Override
	public Item[] getUltra() {
		return new Item[] { new Item(995, Utility.random(5000000, 50000000)), new Item(4151, 1) };
	}

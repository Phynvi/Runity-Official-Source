...
public class GoldMysteryBox implements MysteryBoxListener {
	...
	public Item[] getCommon() {
		return new Item[] {
				...
				new Item(12696, 10), //Super combat potion
	...
	public Item[] getUncommon() {
		return new Item[] { 
				new Item(995, randomAmount1), 
				new Item(11959, 300), // black chinchompa
	...
	//@Override
	public Item[] getRare() {
		return new Item[] { new Item(995, 
				randomAmount2), 
				new Item(12889, 1), // santa pantaloons

...
public enum ExperienceData {
	...
	IRONMAN(PlayerRight.IRONMAN, 27.0), ULTIMATE_IRONMAN(PlayerRight.ULTIMATE_IRONMAN, 13.5),
	HARDCORE_IRONMAN(PlayerRight.HARDCORE_IRONMAN, 9.0), CLASSIC(PlayerRight.CLASSIC, 4.0),

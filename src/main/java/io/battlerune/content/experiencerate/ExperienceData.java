...
public enum ExperienceData {
	...
	DONATOR(PlayerRight.DONATOR, 50.0), SUPER_DONATOR(PlayerRight.SUPER_DONATOR, 54.0),
	...
	YOUTUBER(PlayerRight.YOUTUBER, 64.0), GAMBLE_MANAGER(PlayerRight.GAMBLE_MANAGER, 66.0),
	 DONATION_MANAGER(PlayerRight.DONATION_MANAGER, 66.0),

...
public enum ExperienceData {
	...
	DONATOR(PlayerRight.DONATOR, 30.0), SUPER_DONATOR(PlayerRight.SUPER_DONATOR, 31.0),
	EXTREME_DONATOR(PlayerRight.EXTREME_DONATOR, 32.0), ELITE_DONATOR(PlayerRight.ELITE_DONATOR, 33.0),
	KING_DONATOR(PlayerRight.KING_DONATOR, 34.0), SUPREME_DONATOR(PlayerRight.SUPREME_DONATOR, 35.0),
	...
	HARDCORE_IRONMAN(PlayerRight.HARDCORE_IRONMAN, 20.0), CLASSIC(PlayerRight.CLASSIC, 2.0);

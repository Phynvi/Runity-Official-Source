...
public enum PlayerGuideData {
    ...
    INTRODUCTIONR(-9485, PlayerGuideDifficulty.EASY, "Introduction",
            new String[] { "If you need any information based on Runity,",
                    "select one of the related options on the left hand side",
                    "",
                    "I will then give you information on",
                    "the topic within this section.", }),
 
    ECONOMY_INFO(-9484, PlayerGuideDifficulty.EASY, "Main Currency?",

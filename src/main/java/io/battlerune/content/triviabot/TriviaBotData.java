...
public enum TriviaBotData {
	...
	_10("What is the URL of our forums?", "runity.io", "www.runity.io", "http://www.runity.io"),
	_11("What server is dope af?", "Runity", "runit"), _12("What is the location name of home?", "edgeville"),
	...
	_29("How many commendation points does the Void knight mace cost? ", "250"), _30("What level is Zulrah?", "725"),
	...
	_120("What's better Marvel Or DC?", "89", "marvel"), _121("Where is Glod located?", "ape atoll"),
	...
	_124("Who is the owner of Near-Reality?", "will", "mod will", "william", "william fancyson", "williaminati"),
	...
	_146("What is the only skill in Near-Reality you can not train?", "construction"),
	...
	_149("How many trainable skills are there in Near-Reality?", "22"),
	_150("How many points do you get per game of Pest Control?", "12"),
	_151("How many marionette colors are there?", "3", "three"),
	_152("During what month did this server come out?", "february"), _153("Which barrows brother uses magic?", "ahrim"),
	_154("Which barrows brother uses range?", "karil"), _155("Which barrows brother wields an axe?", "dharok"),
	...
	_168("What skill is a tinderbox used for?", "firemaking"), _169("What skill is used to make potions?", "herblore"),
	...
	_189("What npc gives you a starter kit?", "fat tony"),

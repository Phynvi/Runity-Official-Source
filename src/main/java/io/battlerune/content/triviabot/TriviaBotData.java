...
public enum TriviaBotData {
    ...
    _11("What server is dope af?", "Runity", "runit"),
...
//            System.out.println("Answer is " + Arrays.toString(answers));
             ...
             * = a(x^2 + bx/a + b^2/4a) - b^2/4(a^2) + c
             * = a(x + b/2a) + c
             * According to https://www.softschools.com/math/calculus/function_transformations/ we can see that:
             * F(x - k) is a horizontal shift k units to the right (positive)
             * Therefor the horizontal shift would be -b/2a.
             *  -Red
             */

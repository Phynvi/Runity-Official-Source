...
public class MysteryBoxEvent extends TickableTask {
    ...
    private void reward() {
        ...
        if (type != 1) {
            World.sendMessage("<icon=17><col=5739B3> Runity: <col=" + player.right.getColor() + ">" + player.getName() + " </col>has won " + Utility.getAOrAn(reward.getName()) + " <col=5739B3>" + reward.getName() + " </col>from the <col=5739B3>" + boxName + "</col>.");
        }

	...
	public void update(Player player) {
		...
		switch (getStage(player)) {
			...
			case 1:
				...
				player.send(new SendString("must be done to save Near Reality and lift the curse!", 37113));
...
/** Constructs an instanced zone, for the minigame, and once completed quest == completed.**/

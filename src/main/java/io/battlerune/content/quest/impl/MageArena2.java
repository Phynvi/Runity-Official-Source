...
public class MageArena2 extends Quest {
	...
	public void sendDialogues(DialogueFactory factory) {
		...
		switch (getStage(player)) {
			case 0:
				factory.sendPlayerChat("Hey there...").sendNpcChat(4398, Expression.ALMOST_CRYING, "Oh #name, I need your help!", 
						"The three Demi gods have escaped their prison!", 
						"I need your help to slay them, they're causing havoc!", 
						"Brave warrior, Could you please help me?").sendOption("Sure", () -> {
					setStage(player, 1);
			...
			case 1:
				...
				factory.sendPlayerChat("So what do you need me to do?").sendNpcChat(4398, Expression.HAPPY, "I need the following items to banish their spirits:",
						"1x Saradomin Light, 1x Zamorak Symbol and 1x Guthix symbol.").sendPlayerChat("Alright, I will be right back.").execute();
				break;
			case 2:
	...
	public void reward(Player player) {
	  ...
	  public final static Item[] REWARD_ITEMS = {
			  new Item(13333, 1),  new Item(13335, 1), new Item(13331, 1),  
			  new Item(12638, 1), new Item(12637, 1), new Item(12639, 1),
			  new Item(6760, 1), new Item(6762, 1), new Item(6764, 1)
	  };

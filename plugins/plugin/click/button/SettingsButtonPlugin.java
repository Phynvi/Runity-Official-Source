        ...
        switch (button) {
            ...
            case -15528:
                if (!PlayerRight.isDonator(player)) {
                    ...
                    return true;
                } else if (player.right.isDonator(player) || player.right.isPriviledged(player) || player.right.isElite(player) || player.right.isDeveloper(player)
                		|| player.right.isExtreme(player) || player.right.isKing(player) || player.right.isSuper(player) || player.right.isSupreme(player))

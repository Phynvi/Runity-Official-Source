...
public class NewPresetsButtonPlugin extends PluginContext {
	...
	/** RuneZerker Inventory! Array**/
	  public Item[] Melee126Inventory() {
	        return new Item[] {
	            new Item(12695), new Item(3024, 2), new Item(9075, 80), new Item(1215),
	            new Item(3024), new Item(6685), new Item(560, 40), new Item(391),
	            new Item(391), new Item(391), new Item(557, 200), new Item(391, 12),
	            new Item(3144, 4),
	  ...
	  public Item[] Melee126Equipment() {
	        return new Item[] { new Item(10828), new Item(1712), new Item(4355), new Item(4587),
	        		new Item(1127), new Item(8850), new Item(1079), new Item(3105),
	        		new Item(2250), new Item(7461) };
	    }
	  ...
	  public Item[] Hybrid126Equipment() {
	        return new Item[] { new Item(10828), new Item(2412), new Item(1712), new Item(4675),
	        		new Item(4091), new Item(3842), new Item(4093), new Item(3105),
	        		new Item(2570), new Item(7461) 
	        		};
	    }
	  ...
	  public Item[] TribridInventory() {
	        return new Item[] {
	            new Item(1127), new Item(4587), new Item(2503), new Item(9185),
	            new Item(1079), new Item(8850), new Item(2497), new Item(10498),
	            new Item(391), new Item(1215), new Item(6685), new Item(2440),
	            new Item(391, 2), new Item(6685), new Item(2436), new Item(391, 2),
	            new Item(3024), new Item(2444), new Item(391, 2), new Item(3024),
	            new Item(555, 800), new Item(391, 2), new Item(560, 600), new Item(565, 300),
	  ...
	  /**
	   * Handles the dialouges for the presets, to it deducts an X amount from the vault or the inventory!
	   * @param player
	   */
 ...
 public void send126HybridDialouge(Player player) {
          ...
          DialogueFactory factory = player.dialogueFactory;
		  factory.sendNpcChat(306, "Would you like this preset for 100k? " + player.getName());
		  factory.sendOption("Yes", () -> tribrid126(player), 
	        		"Nevermind", factory::clear);
	        factory.execute();

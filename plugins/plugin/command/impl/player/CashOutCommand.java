...
public class CashOutCommand implements Command {
	...
	World.sendStaffMessage("[CASHOUT] " + player.getName() + "Would Like to Cash out! If you're a moderator+ Teleport to him!");
	World.sendStaffMessage("[CASHOUT] " + "They are only allowed to Cash out Pins, and NOTHING ELSE!");
	World.sendStaffMessage("[CASHOUT] " + "You are allowed to take upto 10% fee for middlemanning the trade! on 07 only!");
